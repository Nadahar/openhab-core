...
public class ItemEventFactoryTest {
    ...
    public static final List<StateTestCase> STATE_TEST_SOURCE = List.of(
            ...
            new StateTestCase("ItemB", OnOffType.ON, SOURCE, "{\"type\":\"OnOff\",\"value\":\"ON\"}", OnOffType.ON,
                    null),
            new StateTestCase("ItemC", new DateTimeType("2019-11-11T13:50").toZone(ZoneId.of("Africa/Addis_Ababa")),
                    SOURCE, "{\"type\":\"DateTime\",\"value\":\"2019-11-11T15:50:00+03:00[Africa/Addis_Ababa]\"}",
    ...
    public static final List<StateChangedTestCase> STATE_CHANGED_TEST_SOURCE = List.of(new StateChangedTestCase("ItemA",
            ...
            new StateChangedTestCase("ItemB", new DateTimeType("2019-11-11T09:40").toZone(ZoneId.of("Africa/Cairo")),
                    new DateTimeType("2019-11-11T13:50").toZone(ZoneId.of("Africa/Addis_Ababa")),
                    ZonedDateTime.parse("2026-02-02T17:28:34-04:00"), ZonedDateTime.parse("2026-02-02T17:24:12-04:00"),
                    SOURCE,
                    "{\"type\":\"DateTime\",\"value\":\"2019-11-11T15:50:00+03:00[Africa/Addis_Ababa]\",\"oldType\":\"DateTime\",\"oldValue\":\"2019-11-11T10:40:00+02:00[Africa/Cairo]\",\"lastStateUpdate\":\"2026-02-02T17:28:34-04:00\",\"lastStateChange\":\"2026-02-02T17:24:12-04:00\"}",
                    DateTimeType.valueOf("2019-11-11T10:40:00+02:00[Africa/Cairo]"),
                    DateTimeType.valueOf("2019-11-11T15:50:00+03:00[Africa/Addis_Ababa]"), null),
