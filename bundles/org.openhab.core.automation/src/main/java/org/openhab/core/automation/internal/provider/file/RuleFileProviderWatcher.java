...
/**
 * This class is a wrapper of multiple {@link RuleProvider}s, responsible for initializing the WatchService.
 *
 * @author xxx - Initial contribution
 */
@NonNullByDefault
@Component(immediate = true, service = RuleProvider.class)
public class RuleFileProviderWatcher extends RuleFileProvider { //TODO: (Nad) JavaDocs

    private final WatchService watchService;

    @Activate
    public RuleFileProviderWatcher(
