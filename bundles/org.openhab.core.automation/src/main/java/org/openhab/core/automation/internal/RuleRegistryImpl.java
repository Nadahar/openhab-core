...
public class RuleRegistryImpl extends AbstractRegistry<Rule, String, RuleProvider>
    ...
    private void resolveConfiguration(Rule rule) throws IllegalArgumentException {
        ...
        if (templateState == TemplateState.INSTANTIATED) {
            ...
            try {
                ...
                throw new IllegalArgumentException(String.format("The rule '%s' has incorrect configuration: %s", uid, e.getMessage()), e);
            }
        }
    }
     ...
     */
    private void validateConfiguration(List<ConfigDescriptionParameter> configDescriptions, //TODO: (Nad) Complete throws doc
