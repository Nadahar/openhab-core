...
class RulesFormatter extends AbstractDeclarativeFormatter {
	...
	override protected void configureFormatting(FormattingConfig c) {
        ...
        c.setLinewrap(1, 1, 2).after(getRuleAccess.andKeyword_6_4_0)
        c.setLinewrap(1, 1, 2).before(getRuleAccess.whenKeyword_3)
        c.setLinewrap(1, 1, 2).after(getRuleAccess.whenKeyword_3)
        c.setLinewrap(1, 1, 2).before(getRuleAccess.butKeyword_6_0)
        c.setLinewrap(1, 1, 2).after(getRuleAccess.ifKeyword_6_2)
        c.setLinewrap(1, 1, 2).before(getRuleAccess.thenKeyword_7)
        c.setLinewrap(1, 1, 2).after(getRuleAccess.thenKeyword_7)
        c.setLinewrap(1, 1, 2).before(getRuleAccess.endKeyword_9)

        c.setIndentationIncrement.after("{")
        c.setIndentationDecrement.before("}")
        c.setIndentationIncrement.after(getRuleAccess.whenKeyword_3)
        c.setIndentationDecrement.before(getRuleAccess.butKeyword_6_0)
        c.setIndentationIncrement.after(getRuleAccess.ifKeyword_6_2)
        c.setIndentationDecrement.before(getRuleAccess.thenKeyword_7)
        c.setIndentationIncrement.after(getRuleAccess.thenKeyword_7)
        c.setIndentationDecrement.before(getRuleAccess.endKeyword_9)
