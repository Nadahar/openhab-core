...
public class YamlRuleTemplateDTOTest {
    ...
    public void testConstructor() {
        ...
        assertNotNull(new YamlRuleTemplateDTO(template, RuleSerializationOption.NORMAL));
        ...
        YamlRuleTemplateDTO templateDTO = new YamlRuleTemplateDTO(template, RuleSerializationOption.NORMAL);
