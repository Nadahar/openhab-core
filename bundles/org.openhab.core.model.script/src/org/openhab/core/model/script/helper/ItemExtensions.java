...
public class ItemExtensions {
     ...
     * @throws IllegalStateException If a {@link ManagedProvider} isn't available.
     */
    public static ItemChannelLink addChannelLink(Item item, String channelUid, @Nullable Map<@Nullable String, @Nullable Object> configProperties) {
        return Channels.addItemChannelLink(item, channelUid, configProperties);
    }
     ...
     * @throws IllegalStateException If a {@link ManagedProvider} isn't available.
     */
    public static @Nullable ItemChannelLink replaceChannelLink(Item item, String channelUid, Object... configProperties) {
     ...
     * @throws IllegalStateException If a {@link ManagedProvider} isn't available.
     */
    public static @Nullable ItemChannelLink replaceChannelLink(Item item, String channelUid, @Nullable Map<@Nullable String, @Nullable Object> configProperties) {
        return Channels.replaceItemChannelLink(item, channelUid, configProperties);
    }
