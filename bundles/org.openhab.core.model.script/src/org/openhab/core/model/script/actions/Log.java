...
public class Log {
    ...
    public static void logDebug(String loggerName, Object format, Object arg) {
        LoggerFactory.getLogger(LOGGER_NAME_PREFIX.concat(loggerName)).debug(format instanceof String formatStr ? formatStr : format == null ? null : format.toString(), arg);
    }
    ...
    public static void logDebug(String loggerName, Object format, Object... args) {
        LoggerFactory.getLogger(LOGGER_NAME_PREFIX.concat(loggerName)).debug(format instanceof String formatStr ? formatStr : format == null ? null : format.toString(), args);
    }
    ...
    public static void logInfo(String loggerName, Object format, Object arg) {
        LoggerFactory.getLogger(LOGGER_NAME_PREFIX.concat(loggerName)).info(format instanceof String formatStr ? formatStr : format == null ? null : format.toString(), arg);
    }
    ...
    public static void logInfo(String loggerName, Object format, Object... args) {
        LoggerFactory.getLogger(LOGGER_NAME_PREFIX.concat(loggerName)).info(format instanceof String formatStr ? formatStr : format == null ? null : format.toString(), args);
    }
    ...
    public static void logWarn(String loggerName, Object format, Object arg) {
        LoggerFactory.getLogger(LOGGER_NAME_PREFIX.concat(loggerName)).warn(format instanceof String formatStr ? formatStr : format == null ? null : format.toString(), arg);
    }
    ...
    public static void logWarn(String loggerName, Object format, Object... args) {
        LoggerFactory.getLogger(LOGGER_NAME_PREFIX.concat(loggerName)).warn(format instanceof String formatStr ? formatStr : format == null ? null : format.toString(), args);
    }
    ...
    public static void logError(String loggerName, Object format, Object arg) {
        LoggerFactory.getLogger(LOGGER_NAME_PREFIX.concat(loggerName)).error(format instanceof String formatStr ? formatStr : format == null ? null : format.toString(), arg);
    }
    ...
    public static void logError(String loggerName, Object format, Object... args) {
        LoggerFactory.getLogger(LOGGER_NAME_PREFIX.concat(loggerName)).error(format instanceof String formatStr ? formatStr : format == null ? null : format.toString(), args);
    }
}
