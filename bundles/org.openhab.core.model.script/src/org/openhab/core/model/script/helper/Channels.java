...
public class Channels {
    ...
    public static ItemChannelLink addItemChannelLink(Item item, String channelUid) {
        ...
        return ScriptServiceUtil.getItemChannelLinkRegistry().add(new ItemChannelLink(item.getName(), new ChannelUID(channelUid)));
    }
     ...
     */
    @NonNullByDefault({})
    public static ItemChannelLink addItemChannelLink(Item item, String channelUid, @Nullable Map<@Nullable String, @Nullable Object> configProperties) {
        if (item == null) {
            throw new IllegalArgumentException("item cannot be null");
        }
        return ScriptServiceUtil.getItemChannelLinkRegistry().add(new ItemChannelLink(item.getName(), new ChannelUID(channelUid), new Configuration(configProperties)));
    }
    ...
    public static @Nullable ItemChannelLink replaceItemChannelLink(Item item, String channelUid) {
        ...
        return ScriptServiceUtil.getItemChannelLinkRegistry().update(new ItemChannelLink(item.getName(), new ChannelUID(channelUid)));
    }
     ...
     */
    @NonNullByDefault({})
    public static @Nullable ItemChannelLink replaceItemChannelLink(Item item, String channelUid, @Nullable Map<@Nullable String, @Nullable Object> configProperties) {
        if (item == null) {
            throw new IllegalArgumentException("item cannot be null");
        }
        return ScriptServiceUtil.getItemChannelLinkRegistry().update(new ItemChannelLink(item.getName(), new ChannelUID(channelUid), new Configuration(configProperties)));
    }
